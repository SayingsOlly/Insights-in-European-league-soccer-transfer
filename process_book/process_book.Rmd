...
The data we got is kind of noise since there are some data we don't need, like some loan fee data and the players transfered from outside the 11 leagues, 
...
The questions about the expenditure for buying players and the imcome form selling palyer of selected league or team in a given period  can be answered in Figure \ref{a2} .

![ the expenditure for buying players and the imcome form selling palyer of selected league or team in a given period\label{a2}](a1.png) 
...
![ The number of transfer players in a given period \label{a3}](chart12.png) 
